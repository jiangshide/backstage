...
func Init() {
	...
	orm.RegisterModel(new(Auth), new(Role), new(RoleAuth), new(User),new(Profile),new(Brand),new(Address),new(Device),new(Update),new(Stop),new(App),new(Channel),new(Advert))
